...
class AppointmentCrontroller {
  ...
  async store(req, res) {
    ...
    await Notification.create({
      content: `Novo agendameno de ${user.name} para ${formatteDate}`,
      user: provider_id,
    });
...
export default new AppointmentCrontroller();
